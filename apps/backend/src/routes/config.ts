...
router.get("/", (req, res) => {
  const config = {
    ...
    model_limits: {
      ...
      OPENAI_TPM_GPT4O_MINI: parseInt(
        process.env.OPENAI_TPM_GPT4O_MINI || "200000",
      ),
      ANTHROPIC_TPM_SONNET: parseInt(
        process.env.ANTHROPIC_TPM_SONNET || "80000",
      ),
      ANTHROPIC_TPM_HAIKU: parseInt(
        process.env.ANTHROPIC_TPM_HAIKU || "150000",
      ),
    },
    ...
    effective_routing: {
      ...
      market_phase1: getEffectiveModel(
        "MARKET_PHASE1",
        getEffectiveModel("MARKET", "gpt-4o-mini"),
      ),
      market_phase2: getEffectiveModel(
        "MARKET_PHASE2",
        getEffectiveModel("MARKET", "gpt-4"),
      ),
      ...
      gtm_phase1: getEffectiveModel(
        "GTM_PHASE1",
        getEffectiveModel("GTM", "gpt-4o-mini"),
      ),
      gtm_phase2: getEffectiveModel(
        "GTM_PHASE2",
        getEffectiveModel("GTM", "gpt-4"),
      ),
      financial_plan: getEffectiveModel("FINANCIAL_PLAN", "gpt-4"),
      financial_plan_phase1: getEffectiveModel(
        "FINANCIAL_PLAN_PHASE1",
        getEffectiveModel("FINANCIAL_PLAN", "gpt-4o-mini"),
      ),
      financial_plan_phase2: getEffectiveModel(
        "FINANCIAL_PLAN_PHASE2",
        getEffectiveModel("FINANCIAL_PLAN", "gpt-4"),
      ),
